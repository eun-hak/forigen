...
export default function KoreanHomePage() {
  return <main>
    ...
    <section className="search-section"><div className="section-heading"><div><span className="eyebrow">검색 시작</span><h2>나에게 맞는 장소 찾기</h2></div><p>회원가입 없이 네 가지 조건만 선택하세요.</p></div><SearchWizardKo /></section>
